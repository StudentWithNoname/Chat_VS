...
HOST = '127.0.0.1'  # Zielhost, auf den sich der Client verbindet (localhost für lokale Verbindungen)
PORT = 65432  # Port, der für die Kommunikation mit dem Server verwendet wird; muss mit dem Server übereinstimmen
